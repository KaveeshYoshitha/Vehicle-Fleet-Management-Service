  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: axiosErr.response?.data?.message || "Operation failed.",
        background: "#1e293b",
        color: "#f1f5f9",
      });
    } finally {
    ...
    if (u.isActive) {
      ...
      try {
        ...
        Swal.fire({
          icon: "error",
          title: "Error",
          text: axiosErr.response?.data?.message || "Failed.",
          background: "#1e293b",
          color: "#f1f5f9",
        });
      }
    ...
    <Box>
      ...
      >
        ...
        <DialogActions sx={{ p: 3, pt: 1 }}>
          <Button onClick={() => setFormOpen(false)} sx={{ color: "#94a3b8" }}>
            Cancel
          </Button>
          <Button
            variant="contained"
